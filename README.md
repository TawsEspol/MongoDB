...
En este taller aprendimos como trabajar con MongoDB, asi como tambien hacerlo desde Python utilizando el Plugin Pymongo. Para afianzar los conocimientos aprendidos se propone la practica aqui expuesta.

## Dataset ##

[El Dataset](https://think.cs.vt.edu/corgis/json/airlines/airlines.json) que vamos a utilizar (**airlines.json**) tiene informacion correspondiente a reportes mensual de vuelos de algunos aeropuertos de Estados Unidos divididos por Aerolinea ocurridos entre 2003 y 2016. En este DataSet encontraremos informacion como:
- Aeropuerto del Reporte (Código y nombre completo).
- Estadisticas de Vuelos (Numero de vuelos cancelados, a tiempo, totales, atrasados, temperatura, tiempo de atraso, etc.)
...
### ¿Qué aerolinea es la mejor? (Menor proporcion: (Atrasados+Cancelados)/Total) ###
